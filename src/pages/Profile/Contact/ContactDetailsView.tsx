      ...
      <Card className='card' variant='outlined-raised'>
        <CardContent className='card-content'>
          <div className='header'>
            <Typography
              variant='body1'
              className='headingunbold text-primary'
              startDecorator={<HiIdentification size={30} className='mainicon' />}
            >
              Contact Details
            </Typography>

            <span className='pencilicon' onClick={onEditClick}>
              <FiEdit2 size={16} />
            </span>
          </div>
          ...
          <div className='grid'>
            ...
            <div>
              <Typography variant='body1'>Primary Phone</Typography>

              <Typography variant='body2'>{contactData.primaryPhone}</Typography>
            </div>
            ...
            <div>
              <Typography variant='body1'>Preferred Communication</Typography>

              <Typography variant='body2'>{contactData.preferredCommunication}</Typography>
            </div>
          </div>
        </CardContent>
      </Card>

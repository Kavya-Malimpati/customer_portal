  ...
  return (
    <div className='edit-container'>
      ...
      <div className='edit-content'>
        <CardContent>
          <div className='profile-section'>
            ...
            <Typography className='profile-subtext'>Policyholder since 2018</Typography>
          </div>

          <form id='edit-form' onSubmit={onSubmit} noValidate className='form-wrapper'>
      ...
      <div className='edit-footer'>
        ...
        <Button variant='contained' color='primary' fullWidth onClick={handleSubmitClick}>
          Save Changes
        </Button>
      </div>

      <Modal isOpen={!!isConfirmOpen} onClose={onCloseModal} title='Confirm Save'>

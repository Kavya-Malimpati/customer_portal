                ...
                <div className='notification-list'>
                  <div className='notification-row'>
                    <div className='notification-info'>
                      ...
                      <div>
                        <Typography variant='body1' color='primary' className='notification-title'>
                          Policy Updates
                        </Typography>
                        <Typography
                          variant='body1'
            ...
            <CardContent>
              <div className='settings-card-section'>
                ...
                <div className='theme-section'>
                  <Typography variant='body2' color='secondary' className='notification-title'>
                    Interface Theme
                  </Typography>
            ...
            <CardContent>
              <div className='account-content'>
                <div className='account-header'>
                  ...
                  <Typography variant='h4' color='inverse' className='account-title'>
                    Account Security
                  </Typography>
                </div>
            ...
            <CardContent>
              <div className='sms-content'>
                <div className='sms-header'>
                  <Typography variant='h3' color='primary' className='sms-title'>
                    SMS Enrollment
                  </Typography>
                ...
                <div className='sms-toggle-row'>
                  ...
                  <Typography variant='body2'>Enable Text Enrollment</Typography>
                </div>

  ...
  return (
    <Card variant='outlined-raised' className='safety-tips-card'>
      <CardContent className='safety-tips-content'>
        <Typography variant='h3' color='primary' className='safety-tips-title'>
          🛡️ Safety Tips
        </Typography>
        ...
        {tips.map(tip => (
          <div key={tip.id} className='safety-tip-item'>
            ...
            <div className='safety-tip-content'>
              <Typography variant='body2' color='primary' className='safety-tip-title'>
                {tip.title}
              </Typography>

              <Typography variant='caption' color='muted' className='safety-tip-description'>
                {tip.description}
              </Typography>
            </div>
          </div>
